...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  filters: {
    formatReal: function formatReal(arg) {
  ...
  methods: {
    getCategory: function getCategory() {
      ...
      var url = '/products/getCategory';
      this.$http.get(url).then(function (res) {
        return _this.categories = res.data;
      });
    },
    setFile: function setFile(e) {
      this.file = this.$refs.file.files[0]; // console.log("set file", this.file);
    },
    create: function create() {
      ...
      this.$http.post('/products/createProduct', formData, {
        headers: {
    ...
    getProducts: function getProducts() {
      ...
      this.$http.post(url, {
        ...
        return _this3.products = res.data;
      });
    },
    editProducts: function editProducts() {},
    edtProducts: function edtProducts() {
      var _this4 = this;
    ...
    setProductsEdt: function setProductsEdt(product) {
      if (product) {
...
module.exports = __webpack_require__(/*! /Users/renatoreboucas/Projetos/_Projetos/teste_devSquad/teste_devSquad/resources/js/product.js */"./resources/js/product.js");
